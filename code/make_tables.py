...
LABEL = {'Boger': 'Boger et al.\\ (Direct loss)', 'GoDag': 'GoDag', 'GoDag-dense': 'GoDag-dense',
         'GoCo-random': 'GoCo-random', 'GoCo-source': 'Source-smoothed $\\widehat\\Delta_i/\\sqrt{c_i}$', 'GoCo-knap': 'Source-smoothed knapsack ratio',
         'GoCo-score': 'Added-call score', 'GoCo-exp0': 'Source-smoothed $\\widehat\\Delta_i$', 'GoCo-exp1': 'Source-smoothed $\\widehat\\Delta_i/c_i$',
         'GoCo-oracle': 'Realised $\\Delta_i$ (oracle; uses labels)', 'GoCo-dense-knap': 'GoCo-dense, source-smoothed', 'GoCo-dense-learned': 'GoCo-dense (every distinct score)', 'GoCo1block-source': 'GoCo, single-block construction of the first draft',
         'GoCo-knapk0.5': 'GoCo, $\\kappa=0.5$', 'GoCo-knapk2': 'GoCo, $\\kappa=2$', 'GoCo-knapk4': 'GoCo, $\\kappa=4$',
         'GoCo-knapEB': 'GoCo, $\\kappa$ by method of moments', 'GoCo': '\\textbf{GoCo}', 'GoCo-learnedgb': 'Per-call model, gradient boosting', 'GoCo-ens': 'GoCo, rank-average variant'}
